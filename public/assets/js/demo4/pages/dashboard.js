...
var KTDashboard = function() {
    ...
    var dailySalesone = function() {
        var chartContainer = KTUtil.getByID('kt_chart_daily_sales_one');
        ...
        var chartDataOne = {
            labels: ["Opening Strength", "New Joined", "Employee Left",  "Closing Strength", "Attrition %"],
            datasets: [{
                //label: 'Dataset 1',
    ...
    var dailySalestwo = function() {
        var chartContainertwo = KTUtil.getByID('kt_chart_daily_sales_two');
        ...
        var chartDataTwo = {
            labels: ["GP", "DiGi", "Samsung ", "UBER", "Banglalink", "FoodPanda", "NIC", "Robi", "Akash", "IBBL", "CPP", "Genex Store", "BAT"],
            datasets: [{
                //label: 'Dataset 1',
                backgroundColor: KTApp.getStateColor('success'),
                data: [
        ...
        var chart = new Chart(chartContainertwo, {
            type: 'bar',
            data: chartDataTwo,
            options: {
                title: {
    ...
    var dailySalesthree = function() {
        var chartContainerthree = KTUtil.getByID('kt_chart_daily_sales_three');
        ...
        var chartDataThree = {
            labels: ["GP", "DiGi", "Samsung ", "UBER", "Banglalink", "FoodPanda", "NIC", "Robi", "Akash", "IBBL", "CPP"],
            datasets: [{
                //label: 'Dataset 1',
                backgroundColor: KTApp.getStateColor('success'),
                data: [
                ...
                backgroundColor: '#f3f3fb',
                data: [
                    50, 57, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50
                ]
            }]
        };

        var chart = new Chart(chartContainerthree, {
            type: 'bar',
            data: chartDataThree,
            options: {
                title: {
    ...
    var dailySalesfour = function() {
        var chartContainerfour = KTUtil.getByID('kt_chart_daily_sales_four');
        ...
        var chartDataFour = {
            labels: ["IT", "MIS", "Admin", "Operation", "HR", "BD"],
            datasets: [{
                //label: 'Dataset 1',
                backgroundColor: KTApp.getStateColor('success'),
                data: [
        ...
        var chart = new Chart(chartContainerfour, {
            type: 'bar',
            data: chartDataFour,
            options: {
                title: {
