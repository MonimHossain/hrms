...
class CreateEmployeeJourneysTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('employee_journeys', function (Blueprint $table) {
            ...
            $table->foreign('job_role_id')->references('id')->on('job_roles')->onDelete('restrict');
            //$table->foreign('department_id')->references('id')->on('departments')->onDelete('cascade');
            $table->foreign('employment_type_id')->references('id')->on('employment_types')->onDelete('restrict');
            $table->foreign('employee_status_id')->references('id')->on('employee_statuses')->onDelete('restrict');
    ...
    {
        Schema::dropIfExists('employee_journeys');
    }
}
