...
return [
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => 'mahmudul.hasan@genexinfosys.com',

            'from' => [
                'address' => env('MAIL_FROM_ADDRESS', 'hrms@genexinfosys.com'),
                'name' => env('MAIL_FROM_NAME', 'GENEX HRMS'),
            ],
        ],

        'slack' => [
            'webhook_url' => 'https://hooks.slack.com/services/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',
