    ...
    <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
        ...
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__body">
                ...
                <form class="kt-form" action="{{ route('admin.loan.status.history')  }}" method="GET">
                    <div class="row">
                        <div class="col-xl-2">
                ...
                <table class="table table-bordered" id="html_table">
                    ...
                    <tr>
                        ...
                        <th title="Field #4">Due Interval</th>
                        <th title="Field #4">Amount</th>
                        <th title="Field #4">Due Amount</th>
                        <th title="Field #5">Status</th>
                    </tr>
                    </thead>
                    <tbody>
                    @foreach($loanApplication as $row)
                        <tr>
                            ...
                            <td>{{ $row->interval }}</td>
                            <td>{{ $row->due_interval }}</td>
                            <td>{{ $row->amount }}</td>
                            <td>{{ $row->due_amount }}</td>
                            <td>
                                {{ ($row->due_interval === 0) ? 'Paid' : 'Due' }}
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
               {!! $loanApplication->render() !!}
                <!--end: Datatable -->
            </div>
        </div>
