        ...
        <div class="col-md-12">
            ...
            <div class="kt-portlet">
                ...
                <div class="kt-portlet__body">
                    <form action="{{ route('admin.doc.header.template.update') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="form-group col-md-4">
                                <label>Document Header Name</label>
                                <input type="text" value="{{ $documentHeaders->name }}" name="name" class="form-control" required>
                                <input type="hidden" value="{{ $documentHeaders->id }}" name="id" class="form-control">
                                <input type="hidden" value="{{ $documentHeaders->header_path }}" name="header_path_exist" class="form-control">
                                <input type="hidden" value="{{ $documentHeaders->footer_path }}" name="footer_path_exist" class="form-control">
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-12">
                                <label>Document Header File</label>
                                <input type="file" name="header_path" id="" class="form-control">
                                <br>
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="file" name="footer_path" id="" class="form-control">
                                <br>
