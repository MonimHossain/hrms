            ...
            <div class="kt-portlet">
                ...
                <div class="kt-portlet__body">
                    <div class="row">
                        <div class="pull-left">
                            <label>&nbsp;</label><br>
                            @can(_permission(\App\Utils\Permissions::ADMIN_LETTER_AND_DOCUMENTS_CREATE))<a class="btn btn-outline-primary pull-right" href="{{ route('admin.doc.header.template.create') }}">+ Create New</a>@endcan
                        </div>
                    </div>
                        ...
                        <table class="table table-striped custom-table table-nowrap mb-0 kt-datatable">
                            ...
                            <tr>
                                ...
                                <td class="text-bold text-center">
                                    <a class="btn btn-outline-primary" href="{{ route('admin.doc.header.template.edit', ['id'=>$template->id]) }}"><i class="fas fa-pen"></i></a>&nbsp;
                                    <a class="btn btn-outline-primary" href="{{ route('admin.doc.header.template.show', ['id'=>$template->id]) }}"><i class="fas fa-eye"></i></a>&nbsp;
                                </td>
                            </tr>
                                @endforeach
                            </tbody>
