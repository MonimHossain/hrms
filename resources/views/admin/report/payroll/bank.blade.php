                ...
                <div class="kt-portlet">
                                ...
                                <div class="col-sm-12">
                                    <div>
                                        <h3 style="float: left;" class="kt-portlet__head-title">
                                            Bankwise Salary Summary Report
                                        </h3>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="kt-portlet__body">
                        <div class="kt-section">
                            ...
                            <form class="kt-form" action="{{ route('report.payroll.bank.salary.status')  }}" method="get">
                                    ...
                                    <div class="col-xl-4">
                                        <div class="form-group">
                                            ...
                                            <select name="bank_id" class="form-control" id="">
                                                ...
                                                <option {{ (Request::get('bank_id') == $bank->id) ? 'selected' : '' }} value="{{ $bank->id }}">{{ $bank->bank_name }}</option>
                                                @endforeach
                                            </select>
                                            </div>
                                        </div>
                                    ...
                                    <tbody>
                                        @foreach($salaries as $salary)
                                            ...
                                            <tr>
                                                ...
                                                <td style=min-width:50px>{{ (!$salary->employee->individualSalary->bankInfo) ? 'Bank Not Found' : $salary->employee->individualSalary->bankInfo->bank_name }}</td>
