                ...
                <div class="kt-portlet">
                    ...
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">
                                Employee Attendance CSV Missing Report
                            </h3>
                        </div>
                    </div>
                    <br>
                    <div class="kt-portlet__body">
                        <div class="kt-section">
                             <form class="kt-form" action="{{ route('missing.report.employee.attendance.csv') }}" method="GET">
                                <div class="row">
                                    <div class="col-xl-2">
...
<tbody>
  @foreach($salary_history as $salary)
        <tr>
            ...
            <td>{{ $salary->status ? $salary->status : '-' }}</td>
            <td>{{ $salary->createdBy ? $salary->createdBy->fullName : '-' }}</td>
            <td>{{ $salary->updatedBy ? $salary->updatedBy->fullName : '-' }}</td>
            <td>
            <a href="#" redirect="missing.report.employee.attendance.csv" modelName="EmployeeAttendance" id="{{ $salary->id }}" class="lookup_remove"><i class="flaticon-delete"></i></a>
        </tr>
    @endforeach 
</tbody>
</table>
