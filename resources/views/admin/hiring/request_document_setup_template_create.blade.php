	...
	<div class="row">
        <div class="col-md-12">
            ...
            <div class="kt-portlet">
                ...
                <form action="{{ route('admin.request.doc.setup.store') }}" method="post" id="requestDocTemplate">
                    @csrf
                    <div class="row">
                   ...
                   <div class="form-group">
                       <button type="submit" class="btn btn-outline-primary" id="generate-btn">Create</button>
                   </div>
                </form>
