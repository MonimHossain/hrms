	...
	<div class="row">
        <div class="col-md-12">
            ...
            <div class="kt-portlet">
                ...
                <!--begin::Form-->
                <form class=" form" action="{{ route('settings.manage.holidays.create') }}" method="POST">
                    @csrf
                    <div class="container">
                        ...
                        <div class="row margin-top-10">
                            <div class="input-group col-md-12">
                                <textarea name="description" class="form-control" id="" placeholder="Enter details"></textarea>
                            </div>
                            <div class="form-group col-md-12 margin-top-10">
                                ...
                                <div class="checkbox-inline">
                                    ...
                                    @foreach ($religions as $religion)
                                        <label class="kt-checkbox kt-checkbox--tick kt-checkbox--success">
                                            <input type="checkbox" class="religion-checkbox"  value="{{ $religion }}" name="religion[]">
                                            <span></span>{{ $religion }}
                                        </label>
                                    @endforeach
                                </div>
