	...
	<div class="row">
        <div class="col-md-12">
            ...
            <div class="kt-portlet">
                ...
                <!--begin::Form-->
                    <form class="kt-form" action="{{route('settings.manage.department.update', ['id' => $department->id])}}" method="POST">
                        @csrf
                            ...
                            <div class="row">
                                    ...
                                    <div class="input-group">
                                        <select name="own_hod_id" class="form-control kt-select2" id="kt_select2_2" required>
                                            ...
                                            @foreach($employees as $employee)
                                                <option {{ ($department->own_hod_id == $employee->id)? 'selected="selected"':'' }} value="{{ $employee->id }}">{{ $employee->employer_id }} : {{ $employee->FullName }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="input-group">
                                        <select name="own_in_charge_id" class="form-control kt-select2" id="kt_select2_3" required>
                                            ...
                                            @foreach($employees as $employee)
                                                <option {{ ($department->own_in_charge_id == $employee->id)? 'selected="selected"':'' }} value="{{ $employee->id }}">{{ $employee->employer_id }} : {{ $employee->FullName }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="hidden" name="fld_id" value="{{$department->id}}">
                                        <input type="text" class="form-control" value="{{$department->name}}" placeholder="Add New Department" name="name">
