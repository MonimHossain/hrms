	...
	<div class="row">
        <div class="col-md-12">
            ...
            <div class="kt-portlet">
                ...
                <!--begin::Form-->
                <form class="kt-form" action="{{route('settings.manage.designation.update', ['id' => $designation->id])}}" method="POST">
                    @csrf
                    <div class="kt-portlet__body">
                        <div class="form-group ">
                            ...
                            <div class="input-group">
                                ...
                                <input type="hidden" name="fld_id" value="{{$designation->id}}">
                                <input type="text" class="form-control" value="{{$designation->name}}" placeholder="Add New Dasignation" name="name">
