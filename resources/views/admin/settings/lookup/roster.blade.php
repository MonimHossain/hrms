	...
	<div class="row">
        <div class="col-md-12">
            ...
            <div class="kt-portlet">
                ...
                <!--begin::Form-->
                <form class="kt-form" action="{{ route('settings.manage.roster.create') }}" method="POST">
                    @csrf
                        ...
                        <div class="form-group ">
                            <div class="row">
                                <div class="col-3">
                                    ...
                                    <input class="form-control" id="kt_timepicker_2" readonly placeholder="Select time" type="text" name="start_time" />
                                </div>
                                <div class="col-3">
                                    <label for="end-time">End Time</label>
                                    <input id="kt_timepicker_2" id="end-time" type="text" class="form-control"
                                         name="end_time">
                                </div>
                                <div class="col-3">
                                    <label for="end-time">Title</label>
                                    <input type="text" class="form-control" placeholder="Add New Title" name="title">
                                </div>
                                <div class="col-3">
