                ...
                <div class="kt-portlet">
                    ...
                    <div class="kt-portlet__body">
                        <div class="kt-section">
                            <form class="kt-form" action="{{ route('manage.salary.employee.attendance') }}" method="GET">
                                <div class="row">
                                    <div class="col-xl-2">
                                    ...
                                    <div class="col-xl-3">
                                        <div class="form-group">
                                            ...
                                            <select id="employee_id" name="employee_id" class="form-control kt-selectpicker employee_id" data-live-search="true"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <a href="#" title="Add Employee Attendance" form-size="modal-lg" data-toggle="modal"  data-target="#kt_modal" action="{{ route('add.salary.employee.attendance') }}" class="custom-btn globalModal btn btn-sm btn-primary pull-letf">
                                        Add new record
                                    </a>
                            @canany([_permission(\App\Utils\Permissions::EMPLOYEE_HOUR_CLEARANCE_VIEW)])
                            <a href="#" title="Employee Attendance Clearance" form-size="modal-md" data-toggle="modal"  data-target="#kt_modal" action="{{ route('upload.salary.employee.attendance.clearance.view', ['startDate'=>$startDate, 'endDate'=>$endDate]) }}" class="custom-btn globalModal btn btn-sm btn-primary pull-right">
                                Clearance
                            </a>
                            @endif
</div>
...
<tbody>
    @foreach($salary_history as $salary)
        <tr>
            ...
            <td>
            <a href="#" title="Edit Employee Attendance" form-size="modal-lg" data-toggle="modal"  data-target="#kt_modal" action="{{ route('edit.salary.employee.attendance', ['id'=>$salary->id]) }}" class="text-primary custom-btn globalModal">
                <i class="flaticon-edit"></i>
            </a>
            | <a href="#" redirect="manage.salary.employee.attendance.delete" modelName="EmployeeAttendance" id="{{ $salary->id }}" class="lookup_remove"><i class="flaticon-delete"></i></a>
            </td>
        </tr>
    @endforeach
</tbody>
