    ...
    <tr>
        <td>
            <div class="d-flex flex-column flex-root">
                <span class="font-weight-bolder mb-2"><b>Employee Name:</b>  <span class="opacity-70">{{ $salaryBreakdown['userInfo']['employer_id'] ?? ''}}</span></span>
...
<table style="width: 100%;">
    ...
    <tbody>
        ...
        <tr class="font-weight-boldest">
            ...
            <td style="padding: 5px;border: 1px solid black;border-collapse: collapse; " class="text-right pt-7">{{ number_format($value, 2) }}</td>
        </tr>
        @endforeach
    </tbody>
</table>
            ...
            <table class="table" style="width: 100%; border-collapse: collapse;">
                ...
                <tbody>
                    ...
                    <tr class="font-weight-boldest">
                        ...
                        <td style="padding: 5px;border: 1px solid black;border-collapse: collapse; " class="pl-0 pt-7"> {{ $value->adjustmentType->name }}</td>
                        <td style="padding: 5px;border: 1px solid black;border-collapse: collapse; " class="text-right pt-7">{{ $value->amount }}</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
