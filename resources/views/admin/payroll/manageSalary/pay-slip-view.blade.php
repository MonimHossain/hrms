<div class="row justify-content-center py-8 px-8 py-md-27 px-md-0 invoice-body" id="printcontent">
        <div class="col-md-11">
            ...
            <div class="d-flex justify-content-between pt-5 pb-5">
                <div class="d-flex flex-column flex-root">
                    <span class="font-weight-bolder mb-2"><b>Employee ID:</b>  <span class="opacity-70">{{ $salaryBreakdown['userInfo']['employer_id'] ?? ''}}</span></span>
            ...
            <div class="table-responsive">
                <table class="table">
                        ...
                        <tr class="font-weight-boldest">
                            ...
                            <td class="pr-0 pt-7 text-right text-success text-uppercase">{{ $value[2] }}</td>
                        </tr>
                        @endforeach
    ...
    @isset($salaryBreakdown['adjustment'])
        <br>
        <div class="row justify-content-center py-4 px-4 py-md-11 px-md-0">
            <div class="col-md-11">
                <div class="table-responsive">
                    <b>KPI</b>
                    <table class="table">
                        ...
                        <tbody>
                            @foreach($salaryBreakdown['kpis'] as $key=> $value)
                            <tr class="font-weight-boldest">
                                <td class="pl-0 pt-7"> {{ $value->grade }}</td>
                                <td class="text-right pt-7 text-success text-uppercase">{{ number_format($value->amount, 2) }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr class="font-weight-boldest">
                                ...
                                <td class="text-right pt-7 text-success text-uppercase">(+) {{ $value }}</td> -->
                                <td class="pl-0 pt-7"> {{ $value->adjustmentType->name }}</td>
                                <td class="text-right pt-7 text-success text-uppercase">(+) {{ $value->amount }}</td>
                            </tr>
                            @endforeach
                            @foreach($salaryBreakdown['adjustment']['other_allowances'] as $key=> $value)
                            <tr class="font-weight-boldest">
                                <td class="pl-0 pt-7"> {{ $key }}</td>
                                <td class="text-right pt-7 text-success text-uppercase">(+) {{ $value }}</td>
                            </tr>
                ...
                <div class="table-responsive">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr class="font-weight-boldest">
                                <td class="pl-0 pt-7"> {{ $key }}</td>
                                <td class="text-right pt-7 text-success text-uppercase"><span class="text-danger">(-)</span> {{ $value }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr class="font-weight-bolder">
                            ...
                            <td class="font-size-h3 font-weight-boldest">{{ $salaryBreakdown['userInfo']['gross'] ?? ''}}</td>
                            <td class="font-size-h3 font-weight-boldest">{{ $salaryBreakdown['userInfo']['payable'] ?? ''}}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
