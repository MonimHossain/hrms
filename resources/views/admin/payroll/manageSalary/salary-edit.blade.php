...
<!--begin::Form-->
<input type="hidden" id="salary-breakdown-settings" value="{{ $salaryInfo->individualSalaryBreakdowns }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" value="{{ $branch->bank_routing ?? '' }}" id="bank-routing" name="" disabled>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <div class="input-group date">
                                    <input type="text" class="form-control" autocomplete="off" {{ ($isEditable) ? 'readonly' : '' }} required placeholder="Select date" id="kt_datepicker_3" name="applicable_from" value="{{ $salaryInfo->applicable_from }}"/>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" value="{{ $salaryInfo->gross_salary }}" id="gross-salary" name="gross_salary" {{ ($isEditable) ? 'readonly' : '' }} required>
                            </div>
                        </div>
                        ...
                        {{-- <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <select id="bank" name="type" class="form-control" required>
                                    <option value="">Select</option>
                                    <option {{ ($salaryInfo->type == 0) ? 'selected' : '' }} value="0">Hourly</option>
                                    <option {{ ($salaryInfo->bank_info_id == 1) ? 'selected' : '' }} value="1">Fixed</option>
                                </select>
                            </div>
                        </div> --}}
        ...
        <div class="col-sm-6">
            @if($employmentType == 'Permanent')
                <div class="kt-portlet">
                    ...
                    <div class="kt-portlet__body">
                        @foreach($salaryInfo->individualSalaryBreakdowns as $item)
                ...
                <div class="kt-portlet">
                    ...
                    <div class="kt-portlet__body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input class="form-control " type="text" readonly value="" name="pf">
                            </div>
                            <div class="col-sm-4">
                                <input class="form-control " type="text" readonly value="" name="pf_percentage">
                            </div>
                            <div class="col-md-2">
                                <div class="kt-checkbox-list">
                                    <label class="kt-checkbox kt-checkbox--tick kt-checkbox--success mt-2">
                                        <input type="checkbox" id="pf-status" {{ ($salaryInfo->pf_status == 0) ? 'checked' : '' }} name="pf_status"> Disable
                                        <span></span>
                                    </label>
                                </div>
                                <div class="d-md-none kt-margin-b-10"></div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input class="form-control " type="text" readonly value="" name="tax">
                            </div>
                            <div class="col-sm-4">
                                <input class="form-control " type="text" readonly value="" name="tax_percentage">
                            </div>
                            <div class="col-md-2">
                                <div class="kt-checkbox-list">
                                    <label class="kt-checkbox kt-checkbox--tick kt-checkbox--success mt-2">
                                        <input type="checkbox" {{ ($salaryInfo->tax_status == 0) ? 'checked' : '' }} id="tax-status" name="tax_status"> Disable
                                        <span></span>
                                    </label>
                                </div>
                                <div class="d-md-none kt-margin-b-10"></div>
            ...
            <div class="kt-portlet">
                ...
                <div class="kt-portlet__body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-12">
                            <input class="form-control " id="net-salary" type="text" value="{{ $salaryInfo->payable }}" name="payable" readonly>
                        </div>
                    </div>
