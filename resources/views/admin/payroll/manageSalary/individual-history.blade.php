                ...
                <div class="kt-portlet">
                    ...
                    <div class="kt-portlet__body">
                        <div class="kt-section">
                                    ...
                                    <div class="col-xl-2">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date">
                                                <input type="text" autocomplete="off" class="form-control month-pick" name="date" placeholder="Select Month" value="{{ Request::get('date') }}">
                            ...
                            <table class="table table-striped custom-table table-nowrap mb-0 kt-datatable text-center" width="100%" id="lookup">
                                <thead>
                                <tr>
                                    <th>Employee ID</th>
                                    <th>Name</th>
                                ...
                                <tbody>
                                    @foreach($salary_history as $history)
                                        <tr>
                                            <td>{{ $history->employee->employer_id }}</td>
                                            <td>{{ $history->employee->fullName }}</td>
                                            <td>{{ $history->gross_salary }}</td>
                                            <td>{{ $history->is_hold == 1 ? 'Hold':'Paid' }}</td>
                                            <td>{{ date_format(date_create($history->created_at),"d F Y") }}</td>
                                            <td>{{ $history->createdBy->fullName }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
