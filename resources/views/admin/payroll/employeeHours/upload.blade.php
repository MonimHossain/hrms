                ...
                <div class="kt-portlet">
                    ...
                    <div class="kt-portlet__head">
                        ...
                        <span style="margin-top:5px;" class="float-right text-right">
                            <a href="{{ asset('hrmsDocs/csv/sample_employee_hours.csv') }}" class="">Employee Hours Format Download&nbsp;<i class="fa fa-download" aria-hidden="true"></i></a> <br>
{{--                            <a href="{{ asset('hrmsDocs/csv/employee-adj-hours.csv') }}" class="">Employee Adjusted Hours Format Download&nbsp;<i class="fa fa-download" aria-hidden="true"></i></a>--}}
                        </span>
                        </div>
                    </div>

                    <!--begin::Form-->
                    <form class="kt-form kt-form--label-right" enctype="multipart/form-data" method="POST" action="{{ route('upload.salary.employee.hours') }}">
                        @csrf
                        <div class="kt-portlet__body">
                            <div class="form-group row form-group-marginless kt-margin-t-20">
                                ...
                                <div class="col-lg-2 col-md-9 col-sm-12">
                                    ...
                                    <input type="text" autocomplete="off" readonly name="endDate" class="form-control kt_datepicker_3" id="">
                                </div>--}}
                                {{--<div class="col-lg-3 col-md-9 col-sm-12">
                                    <label >Hour type</label>
                                    <div class="custom-file">
                                        <select class="form-control" name="hour_type" id="">
                                            <option value="regular">Regular</option>
                                            <option value="adj">Adjusted</option>
                                            <option value="ot">Oevrtime</option>
                                        </select>
                                    </div>
                                </div>--}}
                                <div class="col-lg-4 col-md-9 col-sm-12">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="customFile" onchange="getFilePath()" required name="excel_file">
                                        <label class="custom-file-label selected" style="text-align: left" for="customFile" id="customFileLabel"></label>
                                    </div>
                                </div>
                                <div class="col-lg-2 col-md-9 col-sm-12">
                                    <button type="submit" id="uploadData" class="btn btn-brand" style="position: relative; top: 25px">Upload</button>
                                </div>
