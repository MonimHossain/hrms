                ...
                <div class="kt-portlet">
                    ...
                    <div class="kt-portlet__body">
                        <div class="kt-section">
                            <form class="kt-form" action="{{ route('manage.salary.employee.hours') }}" method="GET">
                                <div class="row">
                                    <div class="col-xl-2">
...
<tbody>
    @foreach($salary_history as $salary)
        <tr>
            ...
            <td>
            <a href="#" title="Edit Employee Hour" form-size="modal-lg" data-toggle="modal"  data-target="#kt_modal" action="{{ route('edit.salary.employee.hours', ['id'=>$salary->id]) }}" class="text-primary custom-btn globalModal">
                <i class="flaticon-edit"></i>
            </a>
            | <a href="#" redirect="manage.salary.employee.hours" modelName="EmployeeHours" id="{{ $salary->id }}" class="lookup_remove"><i class="flaticon-delete"></i></a>
            </td>
        </tr>
    @endforeach
</tbody>
