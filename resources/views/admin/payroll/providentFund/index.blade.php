            ...
            <div class="col-md-12">
                ...
                <div class="kt-portlet">
                    ...
                    <div class="kt-portlet__head">
                        ...
                        <div class="row">
                            <a href="{{ asset('hrmsDocs/csv/pf.csv') }}" style="position: relative; top: 33px; right: 10px">Download File Format</a>
                            <a href="#" class="pull-right globalModal" style="vertical-align: middle; height: 38px; position: relative; top: 34px" title="Provident Fund Upload" form-size="modal-md" data-toggle="modal" data-target="#kt_modal" action="{{ route('payroll.provident.fund.upload') }}">| &nbsp;Previous PF Upload</a>
                        </div>
                    </div>
                    <br>
                    <div class="kt-portlet__body">
                        <div class="kt-section">
                                        ...
                                        <div class="card-body ">
                                            <div class="row">
                                                ...
                                                <div class="col-7 col-md-8">
                                                    <div class="numbers"><p class="card-category">PF Enabled Employee</p>
                                    ...
                                    <div class="card card-stats">
                                        <div class="card-body ">
                                            <div class="row">
                                                ...
                                                <div class="col-7 col-md-8">
                                                    <div class="numbers"><p class="card-category">PF Enabled Amount</p>
                                    ...
                                    <div class="card card-stats">
                                        <div class="card-body ">
                                            <div class="row">
                                                ...
                                                <div class="col-7 col-md-8">
                                                    <div class="numbers"><p class="card-category">PF Disable Employee</p>
                                    ...
                                    <div class="card card-stats">
                                        <div class="card-body ">
                                            <div class="row">
                                                ...
                                                <div class="col-7 col-md-8">
                                                    <div class="numbers"><p class="card-category">PF Disable Amount</p>
                            ...
                            <form class="kt-form" action="{{ route('payroll.provident.fund.index')  }}" method="GET">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date">
                                                <input type="text" class="form-control month-pick"
                                                       ...
                                                       id="" name="date_from" value="{{ Request::get('date_from') }}" autocomplete="off"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date">
                                                <input type="text" class="form-control month-pick" readonly
                                                       placeholder="Select Date"
                                                       id="" name="date_to" value="{{ Request::get('date_to') }}" autocomplete="off"/>
                                                <div class="input-group-append">
                                        <span class="input-group-text">
                                            <i class="la la-calendar-check-o"></i>
                                        </span>
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" data-toggle="tab" href="#enable" role="tab">PF Enabled Employee</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="#disable" role="tab">PF Disable Employee</a>
                                </li>
                            </ul>
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane active" id="enable" role="tabpanel">
                                    ...
                                    @if(sizeof($pfActive) !=  0)
                                        <table class="table table-striped table-nowrap mb-0 kt-datatable" width="100%" id="lookup" >
                                            <thead>
                                            <tr>
                                                <th>Employee ID</th>
                                                <th>Name</th>
                                            ...
                                            @foreach($pfActive as $row)
                                                <tr>
                                                    ...
                                                    <td>{{ $row['payable'] }} </td>
                                                    <td>
                                                        <a href="#" class="btn-sm btn-info pull-right globalModal" title="View Details" form-size="modal-md" data-toggle="modal" data-target="#kt_modal" action="{{ route('payroll.provident.fund.details', ['id'=>$row['emp_id']]) }}">View Details&nbsp;</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                            </tbody>
