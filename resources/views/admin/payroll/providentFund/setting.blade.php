                    ...
                    <form class="kt-form" action="{{ route('payroll.provident.fund.setting.update', ['id'=>1]) }}" method="POST">
                        ...
                        <div class="col-md-12">
                            <div class="kt-portlet__body">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <label style="text-align: right">Provident Fund (%)</label>
                                    ...
                                    <div class="col-sm-4">
                                        <label style="text-align: right">Provident Fund Maturity(Year)</label>
                                        <div class="form-group">
                                            <label>
                                                <input type="text" class="form-control" name="pf_year" placeholder="Enter Provident Fund"
                                                       value="{{ $settings->pf_year ?? 0 }}">
                                            </label>
                                        </div>
                                    </div>

                                    <div class="col-sm-4">
                                        <label style="text-align: right">Gratuity Maturity(Year)</label>
                                        <div class="form-group">
                                            <label>
                                                <input type="text" class="form-control" name="gratuity_year" placeholder="Enter Provident Fund"
                                                       value="{{ $settings->gratuity_year ?? 0 }}">
                                            </label>
