        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="kt-portlet">
                    ...
                    @if("add" === $flag)
                        <form class="kt-form" action="{{ route('payroll.provident.fund.create') }}" method="POST">
                    @else
                        <form class="kt-form" action="{{ route('payroll.provident.fund.update', ['id'=>$id]) }}" method="POST">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <label>
                                                <input type="text" class="form-control" required name="employee_id" placeholder="Enter Employee ID"
                                                       value="{{ $rows->employee->employer_id }}">
                                            </label>
                                        </div>
                                    </div>
