        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="kt-portlet">
                    ...
                    @else
                        <form class="kt-form" action="{{ route('asset.my.requisition.update', ['id'=>$id]) }}" method="POST">
                                    ...
                                    @else 
                                        <div class="form-group row">
                                            <div class="col-sm-12">
                                                ...
                                                <label>
                                                    <select {{ ($rows->status != 0) ? 'Disabled':'' }} name="asset_type_id" class="form-control" id="">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-12">
                                                ...
                                                <label>
                                                    <input  {{ ($rows->status != 0) ? 'Disabled':'' }} type="date" class="form-control" required name="due_date" placeholder="Enter Date"
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-12">
                                                ...
                                                <label>
                                                    <textarea {{ ($rows->status != 0) ? 'Disabled':'' }} name="specification" class="form-control" id="" cols="30" rows="10">{{ $rows->specification }}</textarea>
                                                </label>
                                            </div>
                                        </div>
