                ...
                <div class="kt-portlet">
                    ...
                    <div class="kt-portlet__body">
                        <div class="kt-section">                            
                            <form class="kt-form" action="{{ route('asset.requisition')  }}" method="GET">
                                <div class="row">
                                    <div class="col-md-12 text-right">
                                        <a class="btn btn-sm btn-primary" href="{{ route('asset.requisition.add') }}">Add new</a>                            
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-xl-2">
                            ...
                            <table class="table table-striped custom-table table-nowrap mb-0" width="100%" id="lookup">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>                                            
                                            <a href="{{ route('asset.my.requisition.view', ['id'=>$row->id]) }}"><i class="flaticon-eye"></i></a>
                                            @if($row->status == 0)
                                                <a href="{{ route('asset.my.requisition.edit', ['id'=>$row->id]) }}"><i class="flaticon-edit"></i></a>
                                                <a href="{{ route('asset.my.requisition.delete', [$row->id]) }}"><i class="flaticon-delete"></i></a>
                                            @endif
                                        </td>
                                    </tr>
                                    @endforeach
