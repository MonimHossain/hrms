            ...
            <div class="kt-portlet">
                ...
                <div class="row">
                    <div class="col-md-6 offset-md-3">
                        <!--begin::Form-->
                        <form class="kt-form" action="{{ route('create.new.type') }}" method="POST">
                            @csrf
                            <div class="kt-portlet__body">
                                <div class="form-group ">
                                    <div class="input-group">
                                        <input type="text" class="form-control" required placeholder="Add New Type" name="name">
                                        <input type="hidden" class="form-control" required placeholder="Add New Type" name="status" value="1">
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <div class="input-group">
                                        <textarea class="form-control" required placeholder="Add Detals" name="details" id="" cols="30" rows="10"></textarea>
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <div class="input-group">
