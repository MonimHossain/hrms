                ...
                <div class="kt-portlet">
                    ...
                    <div class="kt-portlet__body">
                        <div class="kt-section">
                            ...
                            <form class="kt-form" action="{{ route('user.request.clearance.hr')  }}" method="GET">
                                <div class="row">
                            ...
                            <div class="table-responsive">
                                ...
                                @foreach($employeeClosing as $closing)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" style="width: 110px;" title="Approval For Closing Employee" form-size="modal-md" data-toggle="modal"  data-target="#kt_modal" action="{{ route('user.request.clearance.hr.show', ['id'=>$closing->id]) }}" class="text-primary custom-btn globalModal"><span class="btn-sm btn-outline-primary"><i class="flaticon-edit"></i></span></a>
                                        </td>
                                    </tr>
                                    @endif
                                @endforeach
