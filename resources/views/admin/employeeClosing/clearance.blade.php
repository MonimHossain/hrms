                ...
                <div class="kt-portlet">
                    ...
                    <div class="kt-portlet__body">
                        <div class="kt-section">
                            ...
                            <form class="kt-form" action="{{ route('request.clearance.clearance')  }}" method="GET">
                                <div class="row">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped custom-table table-nowrap mb-0 kt-datatable" width="100%" id="lookup">
                                    ...
                                    @foreach($employeeClosing as $closing)
                                     @if($closing->employeeByApplication->employee)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="#" style="width: 110px;" title="Approval For Closing Employee" form-size="modal-lg" data-toggle="modal"  data-target="#kt_modal" action="{{ route('request.clearance.clearance.show', ['id'=>$closing->id, 'application_id'=> $closing->closing_applications_id]) }}" class="text-primary custom-btn globalModal"><span class="btn-sm btn-outline-primary"><i class="flaticon-edit"></i></span></a>
                                            </td>
                                        </tr>
                                        @endif
                                    @endforeach
