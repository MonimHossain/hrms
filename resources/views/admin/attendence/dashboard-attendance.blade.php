                ...
                {{-- <div class="kt-portlet__body">
                    <div class="kt-portlet__content">
                        <div class="kt-portlet">
                            ...
                            <form action="{{ route('attendance.dashboard') }}" method="get"
                                class=" center-division-form" style="width: 100%">
                                ...
                                <div class="row p-5">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <select required class="form-control kt-select2 division"
                                                    id="kt_select2_222" name="division">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <label>Center</label>
                                            <div>
                                                <select class="form-control kt-select2 center" id="kt_select2_222"
                                                    name="center">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <select class="form-control kt-select2 department" id="kt_select2_22"
                                                    name="department">
                                                    <option value="">Select Option</option>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Process</label>
                                            <div>
                                                <select class="form-control kt-select2 process" id="kt_select2_31"
                                                    name="process">
                                                    <option value="">Select Option</option>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <select class="form-control kt-select2 process-segment"
                                                    id="kt_select2_62" name="process_segment">
                                                    <option value="">Select Option</option>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group " style="margin-top: 25px;">
                                            <button type="submit" class="btn btn-primary"><i
                                                    class="flaticon2-line-chart"></i> Report</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
