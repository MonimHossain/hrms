    <form class="kt-form kt-form--label-right " action="{{ route('admin.employee.appraisal.answer.setting.store') }}" method="POST">
        @csrf
        ...
        <div class="kt-portlet__body">
            <div class="form-group row">
                <div class="col-lg-12">
                    <label class="">Question For:</label>
                    <select class="form-control kt-selectpicker" id="questionFor" data-live-search="true" name="question" autocomplete="off">
            ...
            <div class="form-group row">
                <div class="col-lg-12">
                    ...
                    <select class="form-control" id="questionList" data-live-search="true" name="question" autocomplete="off">
                        <option value="">Select</option>
