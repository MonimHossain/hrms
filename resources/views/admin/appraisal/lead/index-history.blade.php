                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    {{ $name->teamEvaluationStatus->filter(
                                                            function($request){
                                                               return  $request->lead_status == 1;
                                                        })->count()
                                                     }}
                                                </td>
                                                <td>
                                                    <a href="{{ route('evaluation.lead.view', ['id'=>$name->id]) }}" class="btn btn-outline-primary">View</a>
                                                    <a href="" title="Edit Team Lead Evaluation" form-size="modal-lg" data-toggle="modal"  data-target="#kt_modal" action="{{ route('lead.evaluation.name.edit', ['id'=>$name->id]) }}" class="text-primary custom-btn globalModal">
