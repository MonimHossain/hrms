        ...
        <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
            <ul class="kt-menu__nav ">
                ...
                @if(auth()->user()->hasAnyRole('Super Admin|Admin') && request()->session()->get('validateRole') == 'Admin')
                    ...
                    </span><span class="kt-menu__link-text">Roster & Attendance</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
                            <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                                <ul class="kt-menu__subnav">
                                ...
                                <ul class="kt-menu__subnav">
                                    ...
                                    <li class="kt-menu__item {{ ($active == 'employee-attendance') ? 'kt-menu__item--active' : '' }} " aria-haspopup="true"><a
                                            href="{{ route('employee.attendance.view') }}" class="kt-menu__link "><i
                                                class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Individual Atteandance Report</span></a>
                                    </li>

                                    <li class="kt-menu__item {{ ($active == 'employee-dept-attendance') ? 'kt-menu__item--active' : '' }} " aria-haspopup="true"><a
                                            href="{{ route('employee.dept.attendance.view') }}" class="kt-menu__link "><i
                                                class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Full Atteandance Report</span></a>
                                    </li>
