                        ...
                        <div class="kt-section">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped custom-table mb-0" width="100%" id="lookup">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td rowspan="4">{{ $listItem['teamName'] ?? '' }}</td>
                                        </tr>
                                        @foreach($listItem['evaluation'] ?? [] as $list)
                                        <tr>
                                            <td>{{ $list['total'] }} - {{ $list['name'] }}</td>
                                            <td><a href="{{ route('user.lead.evaluation.member.list',['teamId'=>$listItem['id'], 'evaluationId'=>$list['id']  ]) }}" class="btn btn-outline-primary">View Member</a></td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
