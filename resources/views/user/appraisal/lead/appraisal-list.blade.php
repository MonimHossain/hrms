                ...
                <div class="kt-portlet">
                    ...
                    <div class="kt-portlet__body">
                        <div class="kt-section">
                            ...
                            <form class="kt-form" action="{{ route('user.lead.appraisal.list') }}" method="GET">
                                <div class="row">
                                        ...
                                        <table class="table table-striped custom-table table-nowrap mb-0" width="100%" id="">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="" style="position: relative; top: 5px" title="Recommendation"Save form-size="modal-lg" data-toggle="modal"  data-target="#kt_modal" action="{{ route('user.lead.appraisal.recommend', ['id'=>$value->id]) }}" class="text-primary custom-btn globalModal">
                                                            <span class="btn btn-outline-primary">Recommend</span>
                                                        </a>
                                                    </td>
                                                </tr>
                                                @endforeach
